 ...
 */
export declare class URLVariables extends Dictionary<string> implements Omit<HashMap<string, string>, "toJSON"> {
    /**
     * Default Constructor.
     */
    constructor();
...
export declare namespace URLVariables {
    type Iterator = HashMap.Iterator<string, string>;
    type ReverseIterator = HashMap.ReverseIterator<string, string>;
    type Serialize<Instance extends object> = {
        [P in keyof Instance]: Driver.Primitive<Instance[P]> extends object ? never : Driver.Primitive<Instance[P]>;
    };
    function parse<T extends object>(str: string, autoCase?: boolean): Serialize<T>;
    function stringify<T extends object>(obj: T): string;
}
//# sourceMappingURL=URLVariables.d.ts.map