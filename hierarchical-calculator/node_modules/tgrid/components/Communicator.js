...
var Communicator = /** @class */ (function () {
    ...
    Communicator.prototype._Proxy_func = function (name) {
        ...
        var func = function () {
            ...
            return _this._Call_function.apply(_this, __spread([name], params));
        };
            ...
            get: function (_a, newName) {
                if (newName === "bind")
                    return function (thisArg) {
                        ...
                        return func.bind.apply(func, __spread([thisArg], args));
                    };
                    ...
                    return function (thisArg) {
                        ...
                        return func.call.apply(func, __spread([thisArg], args));
                    };
                else if (newName === "apply")
                    return function (thisArg, args) { return func.apply(thisArg, args); };
                return _this._Proxy_func(name + "." + newName);
            }
        });
    };
    /**
    ...
    Communicator.prototype._Call_function = function (name) {
        ...
        return new Promise(function (resolve, reject) {
            // READY TO SEND ?
            var error = _this.inspectReady("Communicator._Call_fuction");
            if (error) {
                reject(error);
                return;
            }
            ...
            _this.promises_.emplace(invoke.uid, new Pair_1.Pair(resolve, reject));
            _this.sendData(invoke);
        });
    };
    /* ----------------------------------------------------------------
        ACCESSORS
    ...
    Communicator.prototype.join = function (param) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        error = this.inspectReady(this.constructor.name + ".join");
                        if (error)
                            throw error;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        try {
                            for (routes_1 = __values(routes), routes_1_1 = routes_1.next(); !routes_1_1.done; routes_1_1 = routes_1.next()) {
                                ...
                                // SECURITY-ERRORS
                                if (name_1[0] === "_")
                                    throw new RuntimeError_1.RuntimeError("Error on Communicator._Handle_function(): RFC does not allow access to a member starting with the underscore: Provider." + invoke.listener + "()");
                                else if (name_1[name_1.length - 1] === "_")
                                    throw new RuntimeError_1.RuntimeError("Error on Communicator._Handle_function(): RFC does not allow access to a member ending with the underscore: Provider." + invoke.listener + "().");
                                else if (name_1 === "toString" && func === Function.toString)
                                    throw new RuntimeError_1.RuntimeError("Error on Communicator._Handle_function(): RFC on Function.toString() is not allowed: Provider." + invoke.listener + "().");
                                else if (name_1 === "constructor" || name_1 === "prototype")
                                    throw new RuntimeError_1.RuntimeError("Error on Communicator._Handle_function(): RFC does not allow access to " + name_1 + ": Provider." + invoke.listener + "().");
                            }
                        }
                        ...
                        return [4 /*yield*/, func.apply(void 0, __spread(parameters))];
                    case 2:
                        ret = _b.sent();
                    ...
                    case 3:
                        exp_1 = _b.sent();
                        this._Send_return(uid, false, exp_1);
                        return [3 /*break*/, 4];
    ...
    Communicator.prototype._Send_return = function (uid, flag, val) {
        ...
        if (flag === false && val instanceof Error) {
            if (val.toJSON instanceof Function)
                val = val.toJSON();
            else
