...
var XML = /** @class */ (function (_super) {
    ...
    XML.prototype._Parser_constructor = function (str) {
        ...
        if (start !== -1) {
            ...
            if (open_cnt !== close_cnt)
                throw new DomainError_1.DomainError("Error on XML.constructor(): invalid XML format was found on the <!DOCTYPE />");
    ...
    XML.prototype._Parse_tag = function (str) {
        ...
        if (start === 0 || end === -1)
            throw new DomainError_1.DomainError("Error on XML.constructor(): invalid XML format, unable to parse tag.");
    ...
    XML.prototype.eraseProperty = function (key) {
        ...
        if (it.equals(this.property_map_.end()) === true)
            throw new OutOfRange_1.OutOfRange("Error on XML.eraseProperty(): unable to find the matched key.");
