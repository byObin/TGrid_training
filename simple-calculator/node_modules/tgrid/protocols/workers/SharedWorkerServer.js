...
var SharedWorkerServer = /** @class */ (function () {
    ...
    SharedWorkerServer.prototype._Handle_connect = function (port, handler) {
        var _this = this;
        var acceptor = null;
        port.onmessage = once_1.once(function (evt) {
            // ARGUMENTS
            var headers = JSON.parse(evt.data);
            // CREATE ACCEPTOR
            acceptor = SharedWorkerAcceptor_1.SharedWorkerAcceptor.create(port, headers, function () {
...
(function (SharedWorkerServer) {
})(SharedWorkerServer = exports.SharedWorkerServer || (exports.SharedWorkerServer = {}));
exports.SharedWorkerServer = SharedWorkerServer;
