 ...
 */
export declare class WorkerServer<Headers extends object, Provider extends object | null> extends Communicator<Provider | undefined> implements IWorkerSystem, IServer<WorkerServer.State> {
    /**
     * @hidden
     */
    private state_;
